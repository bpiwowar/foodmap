...
public class JsonRPCServlet extends HttpServlet {
    final static private Logger LOGGER = Logger.getLogger("coria2015.JsonRPCServlet");

    private final Server server;

    public JsonRPCServlet(Server server) {
        this.server = server;
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            LOGGER.warning("Error while handling request");
        } finally {
    ...
    private class JsonCallHandler {
        ...
        private JsonCallHandler(final HttpServletRequest req, final HttpServletResponse resp) throws IOException {
            ...
            jsonRPCMethods = new JsonRPCMethods(server, new JSONRPCRequest() {
                @Override
